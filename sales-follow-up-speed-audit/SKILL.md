...
description: Measures response time impact on qualification and conversion. Use when the user is diagnosing, planning, reviewing or deciding next actions for sales follow up speed audit in B2B lead generation.
---
...
- the user asks for help with sales follow up speed audit in B2B lead generation.
- the user provides data, screenshots, exports, notes or a URL related to sales follow up speed audit.
...
1. Group leads by source, score, owner, timestamp, first response time and response channel.
2. Compare response speed with contact rate, meeting booked rate, SQL rate and disqualification reasons.
3. Find routing delays, owner gaps, weekend/after-hours leaks and SLA misses.
4. Separate lead quality problems from speed-to-lead problems.
5. Recommend SLA, routing, alerting or prioritization fixes before changing acquisition spend.
...
User: "Can you check this sales follow up speed audit before we make a change?"
