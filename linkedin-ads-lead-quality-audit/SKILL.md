...
description: Diagnoses LinkedIn campaign quality using CRM feedback and cost per qualified lead. Use when the user is diagnosing, planning, reviewing or deciding next actions for linkedin ads lead quality audit in B2B lead generation.
---
...
- the user asks for help with linkedin ads lead quality audit in B2B lead generation.
- the user provides data, screenshots, exports, notes or a URL related to linkedin ads lead quality audit.
...
1. Map LinkedIn campaign objective, audience, form, offer, fields and lead source into one flow.
2. Compare CPL with sales acceptance, role seniority, company fit, meeting rate and opportunity rate.
3. Check whether lead gen forms are too easy for the offer value and buyer stage.
4. Review job titles, company size, industries, exclusions and form questions against ICP.
5. Recommend audience, form, offer or follow-up changes before judging LinkedIn by CPL alone.
...
User: "Can you check this linkedin ads lead quality audit before we make a change?"
