...
description: Produces context for sales: source, intent signals, likely objections, next question. Use when the user is diagnosing, planning, reviewing or deciding next actions for sdr handoff brief generator in B2B lead generation.
---
...
- the user asks for help with sdr handoff brief generator in B2B lead generation.
- the user provides data, screenshots, exports, notes or a URL related to sdr handoff brief generator.
...
1. Extract source, offer, asset, ad promise, form answers, CRM fields and recent behavior for the lead.
2. Summarize likely pain, buyer stage, role, urgency and fit in plain language.
3. List likely objections or qualification gaps the SDR should verify.
4. Create 3 opening questions tied to the source and asset, not generic discovery.
5. Return a concise handoff brief that sales can use without reading the whole funnel history.
...
User: "Can you check this sdr handoff brief generator before we make a change?"
