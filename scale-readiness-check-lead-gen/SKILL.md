...
description: Decides if you should add budget or fix qualification and follow-up first. Use when the user is diagnosing, planning, reviewing or deciding next actions for scale readiness check lead gen in B2B lead generation.
---
...
- the user asks for help with scale readiness check lead gen in B2B lead generation.
- the user provides data, screenshots, exports, notes or a URL related to scale readiness check lead gen.
...
1. Check whether volume, qualified lead rate, sales acceptance, follow-up SLA and tracking confidence are stable enough to scale.
2. Compare marginal cost and quality by source, segment, campaign and offer.
3. Identify the constraint that will break first: audience, offer, page, form, sales capacity, CRM or tracking.
4. Flag false scale signals like low CPL with weak SQL/opportunity rates.
5. Return scale, hold, fix-first or collect-more-data with the gating metric for approval.
...
User: "Can you check this scale readiness check lead gen before we make a change?"
