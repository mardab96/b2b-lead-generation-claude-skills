...
description: Separates search intent quality from keyword bloat and match-type leaks. Use when the user is diagnosing, planning, reviewing or deciding next actions for google ads lead quality audit in B2B lead generation.
---
...
- the user asks for help with google ads lead quality audit in B2B lead generation.
- the user provides data, screenshots, exports, notes or a URL related to google ads lead quality audit.
...
1. Restate the specific decision the user is trying to make about google ads lead quality audit.
...
User: "Can you check this google ads lead quality audit before we make a change?"
