...
description: Checks follow-up emails for relevance, timing and call-to-action clarity. Use when the user is diagnosing, planning, reviewing or deciding next actions for email nurture sequence review in B2B lead generation.
---
...
- the user asks for help with email nurture sequence review in B2B lead generation.
- the user provides data, screenshots, exports, notes or a URL related to email nurture sequence review.
...
1. Map sequence steps, timing, sender, subject, CTA and target stage after the lead magnet or form.
2. Check whether each email advances pain, proof, urgency, qualification or next step.
3. Identify gaps: generic education, weak CTA, no segmentation, no sales context or poor timing.
4. Compare email engagement and replies with source, asset and lead quality where available.
5. Recommend sequence edits, segmentation or sales handoff changes.
...
User: "Can you check this email nurture sequence review before we make a change?"
