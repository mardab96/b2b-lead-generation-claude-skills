...
description: Finds where qualified leads stall before becoming pipeline. Use when the user is diagnosing, planning, reviewing or deciding next actions for lead to opportunity drop off review in B2B lead generation.
---
...
- the user asks for help with lead to opportunity drop off review in B2B lead generation.
- the user provides data, screenshots, exports, notes or a URL related to lead to opportunity drop off review.
...
1. Restate the specific decision the user is trying to make about lead to opportunity drop off review.
...
User: "Can you check this lead to opportunity drop off review before we make a change?"
