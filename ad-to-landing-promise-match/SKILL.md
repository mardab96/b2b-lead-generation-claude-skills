...
description: Verifies that ads, landing page and CTA promise the same thing. Use when the user is diagnosing, planning, reviewing or deciding next actions for ad to landing promise match in B2B lead generation.
---
...
- the user asks for help with ad to landing promise match in B2B lead generation.
- the user provides data, screenshots, exports, notes or a URL related to ad to landing promise match.
...
1. Restate the specific decision the user is trying to make about ad to landing promise match.
...
User: "Can you check this ad to landing promise match before we make a change?"
