...
description: Reverse-engineers competitor angles you are losing to. Use when the user is diagnosing, planning, reviewing or deciding next actions for competitor lead angle review in B2B lead generation.
---
...
- the user asks for help with competitor lead angle review in B2B lead generation.
- the user provides data, screenshots, exports, notes or a URL related to competitor lead angle review.
...
User: "Can you check this competitor lead angle review before we make a change?"
