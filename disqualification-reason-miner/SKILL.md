...
description: Extracts why sales rejects leads and maps it back to targeting or creative. Use when the user is diagnosing, planning, reviewing or deciding next actions for disqualification reason miner in B2B lead generation.
---
...
- the user asks for help with disqualification reason miner in B2B lead generation.
- the user provides data, screenshots, exports, notes or a URL related to disqualification reason miner.
...
1. Restate the specific decision the user is trying to make about disqualification reason miner.
...
User: "Can you check this disqualification reason miner before we make a change?"
